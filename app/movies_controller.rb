...
#                                             Person.where(name: 'Spartacus', rating: 4)
  ...
  # release_date == 2000
  # director == "Me"
#  Movie.find_by({title: "title", release_date: 2000, director: "me")   #FAILING CANNOT FIND MULTIPLE ARGUMENT METHOD 
  #__
...
def can_be_found_updated_and_saved
  ...
  var = Movie.find_by(title: "Awesome Flick")
  var.update(title: "Even Awesomer Flick")
#  Movie.update(title)
  var.save #FAILING
  var
...
def can_update_using_update_method
  ...
  #Movie.find(title)
  var = Movie.find_by(title: "Wat?")
  var.update(title: "Wat, huh?")
  var.save
end
